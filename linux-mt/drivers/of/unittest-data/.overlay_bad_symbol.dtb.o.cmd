cmd_drivers/of/unittest-data/overlay_bad_symbol.dtb.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/of/unittest-data/.overlay_bad_symbol.dtb.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT=3 -D__ASSEMBLY__ -fno-PIE -DCONFIG_AS_LSE=1 -mabi=lp64 -DKASAN_SHADOW_SCALE_SHIFT=3    -c -o drivers/of/unittest-data/overlay_bad_symbol.dtb.o drivers/of/unittest-data/overlay_bad_symbol.dtb.S

source_drivers/of/unittest-data/overlay_bad_symbol.dtb.o := drivers/of/unittest-data/overlay_bad_symbol.dtb.S

deps_drivers/of/unittest-data/overlay_bad_symbol.dtb.o := \
...
drivers/of/unittest-data/overlay_bad_symbol.dtb.o: $(deps_drivers/of/unittest-data/overlay_bad_symbol.dtb.o)
